...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Main Content */}
      <div className="flex-1 hero-gradient flex items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md shadow-2xl border border-border">
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full primary-gradient text-primary-foreground hover:opacity-90"
                size="lg"
              >
                Sign In
              </Button>
